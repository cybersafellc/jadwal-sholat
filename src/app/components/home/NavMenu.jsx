...
export default function NavMenu() {
  return (
    <>
      <ul className="grid grid-cols-3 border border-gray-100 border rounded-2xl overflow-hidden shadow-lg bg-gray-100">
        <Link
          href="/home"
        ...
        <Link href="/sholat" className="flex justify-center items-center">
          <div className="flex gap-1 py-4">
